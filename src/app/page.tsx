  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#101214] px-4 text-white">
      <section className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mt-4 text-4xl font-semibold sm:text-6xl">Cancionero interno para tu equipo</h1>
        <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-400">
          Organiza eventos, canciones, secciones y modo tocar. Para ver contenido interno tenes que iniciar sesion.
        </p>
